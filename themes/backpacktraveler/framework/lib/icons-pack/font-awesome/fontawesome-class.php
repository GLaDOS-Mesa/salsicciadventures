...
if ( ! function_exists( 'backpacktraveler_mikado_add_font_awesome_icon_pack' ) ) {
	function backpacktraveler_mikado_add_font_awesome_icon_pack( $iconCollections ) {
		$iconCollections['font_awesome'] = new BackpackTravelerMikadoClassIconsFontAwesome( 'Font Awesome', 'fa_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_collection', 'backpacktraveler_mikado_add_font_awesome_icon_pack' );
}

if ( ! function_exists( 'backpacktraveler_mikado_add_font_awesome_icon_pack_option' ) ) {
	function backpacktraveler_mikado_add_font_awesome_icon_pack_option( $options ) {
		$options['font_awesome'] = esc_html__( 'Font Awesome', 'backpacktraveler' );
		
		return $options;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_options', 'backpacktraveler_mikado_add_font_awesome_icon_pack_option' );
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_social_options', 'backpacktraveler_mikado_add_font_awesome_icon_pack_option' );
}

class BackpackTravelerMikadoClassIconsFontAwesome implements iBackpackTravelerMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
	public $title;
	public $param;
