...
if ( ! function_exists( 'backpacktraveler_mikado_add_simple_line_icon_pack' ) ) {
	function backpacktraveler_mikado_add_simple_line_icon_pack( $iconCollections ) {
		$iconCollections['simple_line_icons'] = new BackpackTravelerMikadoClassSimpleLineIcons( 'Simple Line Icons', 'simple_line_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_collection', 'backpacktraveler_mikado_add_simple_line_icon_pack' );
}

if ( ! function_exists( 'backpacktraveler_mikado_add_simple_line_icon_pack_option' ) ) {
	function backpacktraveler_mikado_add_simple_line_icon_pack_option( $options ) {
		$options['simple_line_icons'] = esc_html__( 'Simple Line Icons', 'backpacktraveler' );
		
		return $options;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_options', 'backpacktraveler_mikado_add_simple_line_icon_pack_option' );
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_social_options', 'backpacktraveler_mikado_add_simple_line_icon_pack_option' );
}

class BackpackTravelerMikadoClassSimpleLineIcons implements iBackpackTravelerMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
    ...
    public function setSocialIconsArray() {
        $this->socialIcons = array(
            ''                        => '',
            'icon-social-behance'     => esc_html__('Behance', 'backpacktraveler'),
            'icon-social-dribbble'    => esc_html__('Dribbble', 'backpacktraveler'),
            'icon-social-dropbox'     => esc_html__('Dropbox', 'backpacktraveler'),
            'icon-social-facebook'    => esc_html__('Facebook', 'backpacktraveler'),
            'icon-social-foursquare'  => esc_html__('Foursquare', 'backpacktraveler'),
            'icon-social-github'      => esc_html__('Github', 'backpacktraveler'),
            'icon-social-gplus'       => esc_html__('Google Plus', 'backpacktraveler'),
            'icon-social-instagram'   => esc_html__('Instagram', 'backpacktraveler'),
            'icon-social-linkedin'    => esc_html__('LinkedIn', 'backpacktraveler'),
            'icon-social-pintarest'   => esc_html__('Pinterest', 'backpacktraveler'),
            'icon-social-reddit'      => esc_html__('Reddit', 'backpacktraveler'),
            'icon-social-skype'       => esc_html__('Skype', 'backpacktraveler'),
            'icon-social-soundcloud'  => esc_html__('Soundcloud', 'backpacktraveler'),
            'icon-social-stumbleupon' => esc_html__('Stumbleupon', 'backpacktraveler'),
            'icon-social-spotify'     => esc_html__('Spotify', 'backpacktraveler'),
            'icon-social-tumblr'      => esc_html__('Tumblr', 'backpacktraveler'),
            'icon-social-twitter'     => esc_html__('Twitter', 'backpacktraveler'),
            'icon-social-youtube'     => esc_html__('Youtube', 'backpacktraveler')
        );
    }
