...
if ( ! function_exists( 'backpacktraveler_mikado_add_font_elegant_icon_pack' ) ) {
	function backpacktraveler_mikado_add_font_elegant_icon_pack( $iconCollections ) {
		$iconCollections['font_elegant'] = new BackpackTravelerMikadoClassIconsFontElegant( 'Font Elegant', 'fe_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_collection', 'backpacktraveler_mikado_add_font_elegant_icon_pack' );
}

if ( ! function_exists( 'backpacktraveler_mikado_add_font_elegant_icon_pack_option' ) ) {
	function backpacktraveler_mikado_add_font_elegant_icon_pack_option( $options ) {
		$options['font_elegant'] = esc_html__( 'Font Elegant', 'backpacktraveler' );
		
		return $options;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_options', 'backpacktraveler_mikado_add_font_elegant_icon_pack_option' );
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_social_options', 'backpacktraveler_mikado_add_font_elegant_icon_pack_option' );
}
