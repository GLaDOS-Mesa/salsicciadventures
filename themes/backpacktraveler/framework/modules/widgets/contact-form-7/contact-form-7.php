...
if ( class_exists( 'BackpackTravelerCoreClassWidget' ) ) {
    class BackpackTravelerMikadoClassContactForm7Widget extends BackpackTravelerCoreClassWidget {
        public function __construct() {
            parent::__construct(
                'mkdf_contact_form_7_widget',
                esc_html__( 'BackpackTraveler Contact Form 7 Widget', 'backpacktraveler' ),
                array( 'description' => esc_html__( 'Add contact form 7 to widget areas', 'backpacktraveler' ) )
            );
        ...
        protected function setParams() {
            ...
            if ( $cf7 ) {
                ...
                $contact_forms[0] = esc_html__( 'No contact forms found', 'backpacktraveler' );
            }
            ...
            $this->params = array(
                array(
                    'type'  => 'textfield',
                    'name'  => 'extra_class',
                    'title' => esc_html__( 'Extra Class Name', 'backpacktraveler' )
                ),
                array(
                    'type'  => 'textfield',
                ...
                array(
                    'type'    => 'dropdown',
                    'name'    => 'contact_form',
                    'title'   => esc_html__( 'Select Contact Form 7', 'backpacktraveler' ),
                    'options' => $contact_forms
                ),
                array(
                    'type'    => 'dropdown',
                    'name'    => 'contact_form_style',
                    'title'   => esc_html__( 'Contact Form 7 Style', 'backpacktraveler' ),
                    'options' => array(
                        ''                   => esc_html__( 'Default', 'backpacktraveler' ),
                        'cf7_custom_style_1' => esc_html__( 'Custom Style 1', 'backpacktraveler' ),
                        'cf7_custom_style_2' => esc_html__( 'Custom Style 2', 'backpacktraveler' ),
                        'cf7_custom_style_3' => esc_html__( 'Custom Style 3', 'backpacktraveler' )
                    )
                )
            );
        }
        ...
        public function widget( $args, $instance ) {
            ...
            ?>
            <div class="widget mkdf-contact-form-7-widget <?php echo esc_attr( $extra_class ); ?>" <?php echo backpacktraveler_mikado_get_inline_style( $widget_styles ); ?>>
