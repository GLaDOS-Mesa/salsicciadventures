...
<article id="post-<?php the_ID(); ?>" <?php post_class($post_classes); ?>>
    <div class="mkdf-post-content">
	    <?php
            ...
            backpacktraveler_mikado_get_module_template_part('templates/parts/media', 'blog', '', array('post_format' => $post_format));
	    ?>
        <div class="mkdf-post-text-main">
            <div class="mkdf-post-text-main-inner">
			    <?php
			    backpacktraveler_mikado_get_module_template_part('templates/parts/post-type/link', 'blog', '', $part_params);
