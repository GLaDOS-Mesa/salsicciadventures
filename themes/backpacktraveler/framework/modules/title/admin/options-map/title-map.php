...
if ( ! function_exists( 'backpacktraveler_mikado_get_title_types_options' ) ) {
	function backpacktraveler_mikado_get_title_types_options() {
		$title_type_options = apply_filters( 'backpacktraveler_mikado_filter_title_type_global_option', $title_type_options = array() );
		
		return $title_type_options;
	}
}

if ( ! function_exists( 'backpacktraveler_mikado_get_title_type_default_options' ) ) {
	function backpacktraveler_mikado_get_title_type_default_options() {
		$title_type_option = apply_filters( 'backpacktraveler_mikado_filter_default_title_type_global_option', $title_type_option = '' );
...
if ( ! function_exists('backpacktraveler_mikado_title_options_map') ) {
	function backpacktraveler_mikado_title_options_map() {
		$title_type_options        = backpacktraveler_mikado_get_title_types_options();
		$title_type_default_option = backpacktraveler_mikado_get_title_type_default_options();
		...
		$panel_title = backpacktraveler_mikado_add_admin_panel(
			array(
				'page' => '_title_page',
				'name' => 'panel_title',
				'title' => esc_html__('Title Settings', 'backpacktraveler')
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'This option will enable/disable Title Area', 'backpacktraveler' ),
				'parent'        => $panel_title
			)
		);
		
			$show_title_area_container = backpacktraveler_mikado_add_admin_container(
				array(
					'parent'          => $panel_title,
				...
				backpacktraveler_mikado_add_admin_field(
					...
					backpacktraveler_mikado_add_admin_field(
						array(
							...
							'description'   => esc_html__( 'Specify title vertical alignment', 'backpacktraveler' ),
							'parent'        => $show_title_area_container,
							'options'       => array(
		...
		do_action( 'backpacktraveler_mikado_action_additional_title_area_options_map', $show_title_area_container );
		
		/***************** Additional Title Area Layout - end *****************/
		
		
		$panel_typography = backpacktraveler_mikado_add_admin_panel(
			array(
				'page'  => '_title_page',
			...
			$group_page_title_styles = backpacktraveler_mikado_add_admin_group(
				array(
					'name'        => 'group_page_title_styles',
					'title'       => esc_html__( 'Title', 'backpacktraveler' ),
					'description' => esc_html__( 'Define styles for page title', 'backpacktraveler' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_title_styles_1 = backpacktraveler_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_2 = backpacktraveler_mikado_add_admin_row(
					array(
				...
				$row_page_title_styles_3 = backpacktraveler_mikado_add_admin_row(
					array(
			...
			backpacktraveler_mikado_add_admin_section_title(
				array(
					...
					'title'  => esc_html__( 'Subtitle', 'backpacktraveler' ),
					'parent' => $panel_typography
				)
			);
		
			$group_page_subtitle_styles = backpacktraveler_mikado_add_admin_group(
				array(
					'name'        => 'group_page_subtitle_styles',
					'title'       => esc_html__( 'Subtitle', 'backpacktraveler' ),
					'description' => esc_html__( 'Define styles for page subtitle', 'backpacktraveler' ),
					'parent'      => $panel_typography
				)
			);
		
				$row_page_subtitle_styles_1 = backpacktraveler_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_2 = backpacktraveler_mikado_add_admin_row(
					array(
				...
				$row_page_subtitle_styles_3 = backpacktraveler_mikado_add_admin_row(
					array(
		...
		do_action( 'backpacktraveler_mikado_action_additional_title_typography_options_map', $panel_typography );
		
		/***************** Additional Title Typography Layout - end *****************/
    }

	add_action( 'backpacktraveler_mikado_action_options_map', 'backpacktraveler_mikado_title_options_map', backpacktraveler_mikado_set_options_map_position( 'title' ) );
}