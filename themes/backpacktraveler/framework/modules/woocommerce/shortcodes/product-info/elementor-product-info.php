...
class BackpackTravelerCoreElementorProductInfo extends \Elementor\Widget_Base {
    ...
    public function get_title() {
        return esc_html__( 'Product Info', 'backpacktraveler' );
    }

    public function get_icon() {
        return 'backpacktraveler-elementor-custom-icon backpacktraveler-elementor-product-info';
    }
    ...
    protected function register_controls() {
        ...
        $this->add_control(
            'product_id',
            [
                'label'       => esc_html__( 'Selected Product', 'backpacktraveler' ),
        ...
        $this->add_control(
            'product_info_type',
            [
                'label'   => esc_html__( 'Product Info Type', 'backpacktraveler' ),
                'type'    => \Elementor\Controls_Manager::SELECT,
                'options' => [
                    'title'          => esc_html__( 'Title', 'backpacktraveler' ),
                    'featured_image' => esc_html__( 'Featured Image', 'backpacktraveler' ),
                    'category'       => esc_html__( 'Category', 'backpacktraveler' ),
                    'excerpt'        => esc_html__( 'Excerpt', 'backpacktraveler' ),
                    'price'          => esc_html__( 'Price', 'backpacktraveler' ),
                    'rating'         => esc_html__( 'Rating', 'backpacktraveler' ),
                    'add_to_cart'    => esc_html__( 'Add To Cart', 'backpacktraveler' ),
                    'tag'            => esc_html__( 'Tag', 'backpacktraveler' ),
                    'author'         => esc_html__( 'Author', 'backpacktraveler' ),
                    'date'           => esc_html__( 'Date', 'backpacktraveler' ),
                ],
                'default' => 'title'
            ]
        );
        ...
        $this->start_controls_section(
            'product_info_style',
            [
                'label' => esc_html__( 'Product Info Style', 'backpacktraveler' ),
                'tab'   => \Elementor\Controls_Manager::TAB_CONTENT,
            ]
        );
        ...
        $this->add_control(
            'product_info_color',
            [
                'label'     => esc_html__( 'Product Info Color', 'backpacktraveler' ),
        ...
        $this->add_control(
            'featured_image_size',
            [
                'label'     => esc_html__( 'Featured Image Proportions', 'backpacktraveler' ),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'options'   => [
        ...
        $this->add_control(
            'category_tag',
            [
                'label'       => esc_html__( 'Category Tag', 'backpacktraveler' ),
                'type'        => \Elementor\Controls_Manager::SELECT,
        ...
        $this->add_control(
            'add_to_cart_skin',
            [
                'label'       => esc_html__( 'Add To Cart Skin', 'backpacktraveler' ),
                'type'        => \Elementor\Controls_Manager::SELECT,
                'options'     => [
                    ''      => esc_html__( 'Default', 'backpacktraveler' ),
                    'white' => esc_html__( 'White', 'backpacktraveler' ),
        ...
        $this->add_control(
            'add_to_cart_size',
            [
                'label'     => esc_html__( 'Add To Cart Size', 'backpacktraveler' ),
                'type'      => \Elementor\Controls_Manager::SELECT,
                'options'   => [
                    ''       => esc_html__( 'Default', 'backpacktraveler' ),
