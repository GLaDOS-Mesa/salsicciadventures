...
if (!class_exists('BackpackTravelerMikadoClassFullscreenNavigationWalker')) {
	class BackpackTravelerMikadoClassFullscreenNavigationWalker extends Walker_Nav_Menu {
