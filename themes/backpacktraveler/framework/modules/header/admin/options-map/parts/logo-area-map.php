...
if ( ! function_exists( 'backpacktraveler_mikado_get_hide_dep_for_header_logo_area_options' ) ) {
	function backpacktraveler_mikado_get_hide_dep_for_header_logo_area_options() {
		$hide_dep_options = apply_filters( 'backpacktraveler_mikado_filter_header_logo_area_hide_global_option', $hide_dep_options = array() );
		
		return $hide_dep_options;
	}
}

if ( ! function_exists( 'backpacktraveler_mikado_header_logo_area_options_map' ) ) {
	function backpacktraveler_mikado_header_logo_area_options_map( $panel_header ) {
		$hide_dep_options = backpacktraveler_mikado_get_hide_dep_for_header_logo_area_options();
		...
		backpacktraveler_mikado_add_admin_section_title(
			array(
				...
				'title'  => esc_html__( 'Logo Area', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set grid background transparency', 'backpacktraveler' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Set background color for logo area', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Set background transparency for logo area', 'backpacktraveler' ),
				'args'          => array(
					'col_width' => 3
				)
			)
		...
		$logo_area_border_container = backpacktraveler_mikado_add_admin_container(
			array(
				'parent'          => $logo_area_container,
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'label'         => esc_html__( 'Border Color', 'backpacktraveler' ),
				'description'   => esc_html__( 'Set border color for logo area', 'backpacktraveler' ),
		...
		do_action( 'backpacktraveler_mikado_header_logo_area_additional_options', $logo_area_container );
	}
	
	add_action( 'backpacktraveler_mikado_action_header_logo_area_options_map', 'backpacktraveler_mikado_header_logo_area_options_map', 10, 1 );
}