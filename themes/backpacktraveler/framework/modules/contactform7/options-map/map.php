...
if ( ! function_exists('backpacktraveler_mikado_contact_form_7_options_map') ) {

	function backpacktraveler_mikado_contact_form_7_options_map() {
		
		backpacktraveler_mikado_add_admin_page(
			array(
				'slug'  => '_contact_form7_page',
				'title' => esc_html__( 'Contact Form 7', 'backpacktraveler' ),
				'icon'  => 'fa fa-envelope-o'
			)
		);
		
		$panel_contact_form_style_1 = backpacktraveler_mikado_add_admin_panel(
			array(
				'page'  => '_contact_form7_page',
				'name'  => 'panel_contact_form_style_1',
				'title' => esc_html__( 'Custom Style 1', 'backpacktraveler' )
			)
		);
		
		//Text Typography
		
		$typography_text_group = backpacktraveler_mikado_add_admin_group(
			array(
				'name'        => 'typography_text_group',
				'title'       => esc_html__( 'Form Text Typography', 'backpacktraveler' ),
				'description' => esc_html__( 'Setup typography for form elements text', 'backpacktraveler' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_text_row1 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Text Color', 'backpacktraveler' ),
			)
		);
		...
		$typography_text_row2 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		$typography_text_row3 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		$typography_label_group = backpacktraveler_mikado_add_admin_group(
			array(
				'name'        => 'typography_label_group',
				'title'       => esc_html__( 'Form Label Typography', 'backpacktraveler' ),
				'description' => esc_html__( 'Setup typography for form elements label', 'backpacktraveler' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$typography_label_row1 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		$typography_label_row2 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		$background_border_group = backpacktraveler_mikado_add_admin_group(
			array(
				'name'        => 'background_border_group',
				'title'       => esc_html__( 'Form Elements Background and Border', 'backpacktraveler' ),
				'description' => esc_html__( 'Setup form elements background and border style', 'backpacktraveler' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$background_border_row1 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Color', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Background Transparency', 'backpacktraveler' )
			)
		);
		
		$background_border_row2 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Transparency', 'backpacktraveler' ),
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Focus Border Color', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Focus Border Transparency', 'backpacktraveler' )
			)
		);
		
		$background_border_row3 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Radius', 'backpacktraveler' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$padding_group = backpacktraveler_mikado_add_admin_group(
			array(
				'name'        => 'padding_group',
				'title'       => esc_html__( 'Elements Padding', 'backpacktraveler' ),
				'description' => esc_html__('Setup form elements padding', 'backpacktraveler' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$padding_row = backpacktraveler_mikado_add_admin_row(
			array(
				'name'   => 'padding_row',
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Top', 'backpacktraveler' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Right', 'backpacktraveler' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Bottom', 'backpacktraveler' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Padding Left', 'backpacktraveler' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		$margin_group = backpacktraveler_mikado_add_admin_group(
			array(
				'name'        => 'margin_group',
				'title'       => esc_html__( 'Elements Margin', 'backpacktraveler' ),
				'description' => esc_html__( 'Setup form elements margin', 'backpacktraveler' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$margin_row = backpacktraveler_mikado_add_admin_row(
			array(
				'name'   => 'margin_row',
				'parent' => $margin_group
			)
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Top', 'backpacktraveler' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Margin Bottom', 'backpacktraveler' ),
				'args'          => array(
					'suffix' => 'px'
				)
			)
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Textarea Height', 'backpacktraveler' ),
				'description'   => esc_html__( 'Enter height for textarea form element', 'backpacktraveler' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$button_typography_group = backpacktraveler_mikado_add_admin_group(
			array(
				'name'        => 'button_typography_group',
				'title'       => esc_html__( 'Button Typography', 'backpacktraveler' ),
				'description' => esc_html__( 'Setup button text typography', 'backpacktraveler' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_typography_row1 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		$button_typography_row2 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		$button_background_border_group = backpacktraveler_mikado_add_admin_group(
			array(
				'name'        => 'button_background_border_group',
				'title'       => esc_html__( 'Button Background and Border', 'backpacktraveler' ),
				'description' => esc_html__( 'Setup button background and border style', 'backpacktraveler' ),
				'parent'      => $panel_contact_form_style_1
			)
		);
		
		$button_background_border_row1 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Background Hover Color', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Background Hover Transparency', 'backpacktraveler' )
			)
		);
		
		$button_background_border_row2 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'label'  => esc_html__( 'Border Hover Color', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Border Hover Transparency', 'backpacktraveler' )
			)
		);
		
		$button_background_border_row3 = backpacktraveler_mikado_add_admin_row(
			array(
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Height', 'backpacktraveler' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Button Left/Right Padding', 'backpacktraveler' ),
				'args'          => array(
					'col_width' => '3',
					'suffix'    => 'px'
				)
		...
		$panel_contact_form_style_2 = backpacktraveler_mikado_add_admin_panel(array(
			'page'	=> '_contact_form7_page',
			'name'	=> 'panel_contact_form_style_2',
			'title'	=> esc_html__('Custom Style 2', 'backpacktraveler')
		));

		//Text Typography

		$typography_text_group = backpacktraveler_mikado_add_admin_group(array(
			'name'			=> 'typography_text_group',
			'title'			=> esc_html__('Form Text Typography', 'backpacktraveler'),
			'description'	=> esc_html__('Setup typography for form elements text', 'backpacktraveler'),
		...
		$typography_text_row1 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row1',
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row2 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row2',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_text_row3 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'typography_text_row3',
			'next'		=> true,
			'parent'	=> $typography_text_group
		));
		...
		$typography_label_group = backpacktraveler_mikado_add_admin_group(array(
			'name'			=> 'typography_label_group',
			'title'			=> esc_html__('Form Label Typography', 'backpacktraveler'),
			'description'	=> esc_html__('Setup typography for form elements label', 'backpacktraveler'),
			'parent'		=> $panel_contact_form_style_2
		...
		$typography_label_row1 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row1',
			'parent'	=> $typography_label_group
		));
		...
		$typography_label_row2 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'typography_label_row2',
			'next'		=> true,
			'parent'	=> $typography_label_group
		));
		...
		$background_border_group = backpacktraveler_mikado_add_admin_group(array(
			'name'			=> 'background_border_group',
			'title'			=> esc_html__('Form Elements Background and Border', 'backpacktraveler'),
			'description'	=> esc_html__('Setup form elements background and border style', 'backpacktraveler'),
			'parent'		=> $panel_contact_form_style_2
		...
		$background_border_row1 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'background_border_row1',
			'parent'	=> $background_border_group
		));
		...
		$background_border_row2 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'background_border_row2',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$background_border_row3 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'background_border_row3',
			'next'		=> true,
			'parent'	=> $background_border_group
		));
		...
		$padding_group = backpacktraveler_mikado_add_admin_group(array(
			'name'			=> 'padding_group',
			'title'			=> esc_html__('Elements Padding', 'backpacktraveler'),
			'description'	=> esc_html__('Setup form elements padding', 'backpacktraveler' ),
			'parent'		=> $panel_contact_form_style_2
		...
		$padding_row = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'padding_row',
			'parent'	=> $padding_group
		));
		...
		$margin_group = backpacktraveler_mikado_add_admin_group(array(
			'name'			=> 'margin_group',
			'title'			=> esc_html__('Elements Margin', 'backpacktraveler'),
			'description'	=> esc_html__('Setup form elements margin', 'backpacktraveler'),
			'parent'		=> $panel_contact_form_style_2
		...
		$margin_row = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'margin_row',
			'parent'	=> $margin_group
		));
		...
		$button_typography_group = backpacktraveler_mikado_add_admin_group(array(
			'name'			=> 'button_typography_group',
			'title'			=> esc_html__('Button Typography', 'backpacktraveler'),
			'description'	=> esc_html__('Setup button text typography', 'backpacktraveler'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_typography_row1 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row1',
			'parent'	=> $button_typography_group
		));
		...
		$button_typography_row2 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'button_typography_row2',
			'next'		=> true,
			'parent'	=> $button_typography_group
		));
		...
		$button_background_border_group = backpacktraveler_mikado_add_admin_group(array(
			'name'			=> 'button_background_border_group',
			'title'			=> esc_html__('Button Background and Border', 'backpacktraveler'),
			'description'	=> esc_html__('Setup button background and border style', 'backpacktraveler'),
			'parent'		=> $panel_contact_form_style_2
		...
		$button_background_border_row1 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row1',
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row2 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row2',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
		...
		$button_background_border_row3 = backpacktraveler_mikado_add_admin_row(array(
			'name'		=> 'button_background_border_row3',
			'next'		=> true,
			'parent'	=> $button_background_border_group
		));
        ...
        $panel_contact_form_style_3 = backpacktraveler_mikado_add_admin_panel(array(
            'page'	=> '_contact_form7_page',
            'name'	=> 'panel_contact_form_style_3',
            'title'	=> esc_html__('Custom Style 3', 'backpacktraveler')
        ));
        ...
        $typography_label_row3 = backpacktraveler_mikado_add_admin_row(array(
        ...
        $button_typography_row3 = backpacktraveler_mikado_add_admin_row(array(
	...
	add_action( 'backpacktraveler_mikado_action_options_map', 'backpacktraveler_mikado_contact_form_7_options_map', backpacktraveler_mikado_set_options_map_position( 'contact_form_7' ) );
}