...
class MikadoSkin extends BackpackTravelerMikadoClassSkinAbstract {
	
	/**
	 * Skin constructor. Hooks to backpacktraveler_mikado_admin_scripts_init and backpacktraveler_mikado_enqueue_admin_styles
	 */
	public function __construct() {
		$this->skinName = 'mikado';
		
		//hook to
		add_action( 'backpacktraveler_mikado_action_admin_scripts_init', array( $this, 'registerStyles' ) );
		add_action( 'backpacktraveler_mikado_action_admin_scripts_init', array( $this, 'registerScripts' ) );
		
		add_action( 'backpacktraveler_mikado_action_enqueue_admin_styles', array( $this, 'enqueueStyles' ) );
		add_action( 'backpacktraveler_mikado_action_enqueue_admin_scripts', array( $this, 'enqueueScripts' ) );
		
		add_action( 'backpacktraveler_mikado_action_enqueue_meta_box_styles', array( $this, 'enqueueStyles' ) );
		add_action( 'backpacktraveler_mikado_action_enqueue_meta_box_scripts', array( $this, 'enqueueScripts' ) );
		
		add_filter( 'backpacktraveler_mikado_filter_options_map_position', array( $this, 'setOptionsMapPosition' ), 10, 2 );
	...
	public function registerScripts() {
		...
		foreach ( $this->scripts as $scriptHandle => $script ) {
			backpacktraveler_mikado_register_skin_script( $scriptHandle, $script['path'], $script['dependency'] );
		}
	}
    ...
    public function registerStyles() {
        ...
        foreach ($this->styles as $styleHandle => $stylePath) {
            backpacktraveler_mikado_register_skin_style($styleHandle, $stylePath);
        }
    }
    ...
    public function renderOptions() {
        ...
        $tab    		= backpacktraveler_mikado_get_admin_tab();
        $active_page 	= $backpacktraveler_mikado_global_Framework->mkdOptions->getAdminPageFromSlug($tab);
     ...
     *
     * @see BackpackTravelerMikadoClassSkinAbstract::loadTemplatePart()
     */
     ...
     *
     * @param BackpackTravelerMikadoClassAdminPage $page current page to load
	...
	public function renderBackupOptions() { ?>
		<div class="mkdf-options-page mkdf-page">
			<?php $this->getHeader(backpacktraveler_mikado_get_theme_info_item('Name'), backpacktraveler_mikado_get_theme_info_item('Version'), false); ?>
			<div class="mkdf-page-content-wrapper">
				<div class="mkdf-page-content">
					<div class="mkdf-page-navigation mkdf-tabs-wrapper vertical left clearfix">
