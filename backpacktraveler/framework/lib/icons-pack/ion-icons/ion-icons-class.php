...
if ( ! function_exists( 'backpacktraveler_mikado_add_ion_icon_pack' ) ) {
	function backpacktraveler_mikado_add_ion_icon_pack( $iconCollections ) {
		$iconCollections['ion_icons'] = new BackpackTravelerMikadoClassIonIcons( 'Ion Icons', 'ion_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_collection', 'backpacktraveler_mikado_add_ion_icon_pack' );
}

if ( ! function_exists( 'backpacktraveler_mikado_add_ion_icon_pack_option' ) ) {
	function backpacktraveler_mikado_add_ion_icon_pack_option( $options ) {
		$options['ion_icons'] = esc_html__( 'Ion Icons', 'backpacktraveler' );
		
		return $options;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_options', 'backpacktraveler_mikado_add_ion_icon_pack_option' );
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_social_options', 'backpacktraveler_mikado_add_ion_icon_pack_option' );
}

class BackpackTravelerMikadoClassIonIcons implements iBackpackTravelerMikadoInterfaceIconCollection {
	public $icons;
	public $socialIcons;
    public $title;
	public $param;
