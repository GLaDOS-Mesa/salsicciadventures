...
if ( ! function_exists( 'backpacktraveler_mikado_add_linear_icon_pack' ) ) {
	function backpacktraveler_mikado_add_linear_icon_pack( $iconCollections ) {
		$iconCollections['linear_icons'] = new BackpackTravelerMikadoClassLinearIcons( 'Linear Icons', 'linear_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_collection', 'backpacktraveler_mikado_add_linear_icon_pack' );
}

if ( ! function_exists( 'backpacktraveler_mikado_add_linear_icon_pack_option' ) ) {
	function backpacktraveler_mikado_add_linear_icon_pack_option( $options ) {
		$options['linear_icons'] = esc_html__( 'Linear Icons', 'backpacktraveler' );
		
		return $options;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_options', 'backpacktraveler_mikado_add_linear_icon_pack_option' );
}

class BackpackTravelerMikadoClassLinearIcons implements iBackpackTravelerMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
