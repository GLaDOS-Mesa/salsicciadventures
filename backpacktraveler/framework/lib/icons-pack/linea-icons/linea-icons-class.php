...
if ( ! function_exists( 'backpacktraveler_mikado_add_linea_icon_pack' ) ) {
	function backpacktraveler_mikado_add_linea_icon_pack( $iconCollections ) {
		$iconCollections['linea_icons'] = new BackpackTravelerMikadoClassLineaIcons( 'Linea Icons', 'linea_icon' );
		
		return $iconCollections;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_collection', 'backpacktraveler_mikado_add_linea_icon_pack' );
}

if ( ! function_exists( 'backpacktraveler_mikado_add_linea_icon_pack_option' ) ) {
	function backpacktraveler_mikado_add_linea_icon_pack_option( $options ) {
		$options['linea_icons'] = esc_html__( 'Linea Icons', 'backpacktraveler' );
		
		return $options;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_options', 'backpacktraveler_mikado_add_linea_icon_pack_option' );
}

class BackpackTravelerMikadoClassLineaIcons implements iBackpackTravelerMikadoInterfaceIconCollection {
	public $icons;
	public $title;
	public $param;
	public $styleUrl;
