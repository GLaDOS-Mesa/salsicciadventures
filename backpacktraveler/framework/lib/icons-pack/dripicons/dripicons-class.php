...
if ( ! function_exists( 'backpacktraveler_mikado_add_dripicons_icon_pack' ) ) {
	function backpacktraveler_mikado_add_dripicons_icon_pack( $iconCollections ) {
		$iconCollections['dripicons'] = new BackpackTravelerMikadoClassDripicons( 'Dripicons', 'dripicon' );
		
		return $iconCollections;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_collection', 'backpacktraveler_mikado_add_dripicons_icon_pack' );
}

if ( ! function_exists( 'backpacktraveler_mikado_add_dripicons_icon_pack_option' ) ) {
	function backpacktraveler_mikado_add_dripicons_icon_pack_option( $options ) {
		$options['dripicons'] = esc_html__( 'Dripicons', 'backpacktraveler' );
		
		return $options;
	}
	
	add_filter( 'backpacktraveler_mikado_filter_add_icon_pack_into_options', 'backpacktraveler_mikado_add_dripicons_icon_pack_option' );
}

class BackpackTravelerMikadoClassDripicons implements iBackpackTravelerMikadoInterfaceIconCollection {
    public $icons;
    public $title;
    public $param;
    public $styleUrl;
