...
if ( ! function_exists( 'backpacktraveler_mikado_content_bottom_options_map' ) ) {
	function backpacktraveler_mikado_content_bottom_options_map() {
		
		$panel_content_bottom = backpacktraveler_mikado_add_admin_panel(
			array(
				'page'  => '_page_page',
				'name'  => 'panel_content_bottom',
				'title' => esc_html__( 'Content Bottom Area Style', 'backpacktraveler' )
			)
		);
		...
		$enable_content_bottom_area_container = backpacktraveler_mikado_add_admin_container(
			array(
				'parent'          => $panel_content_bottom,
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'default_value' => '',
				'label'         => esc_html__( 'Widget Area to Display', 'backpacktraveler' ),
				'description'   => esc_html__( 'Choose a Content Bottom widget area to display', 'backpacktraveler' ),
	...
	add_action( 'backpacktraveler_mikado_action_additional_page_options_map', 'backpacktraveler_mikado_content_bottom_options_map' );
}