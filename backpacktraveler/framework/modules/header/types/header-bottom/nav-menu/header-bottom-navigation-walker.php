...
if (!class_exists('BackpackTravelerMikadoClassHeaderBottomNavigationWalker')) {
	class BackpackTravelerMikadoClassHeaderBottomNavigationWalker extends Walker_Nav_Menu {
