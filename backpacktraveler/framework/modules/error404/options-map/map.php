...
if ( ! function_exists( 'backpacktraveler_mikado_error_404_options_map' ) ) {
	function backpacktraveler_mikado_error_404_options_map() {
		
		backpacktraveler_mikado_add_admin_page(
			array(
				'slug'  => '__404_error_page',
				'title' => esc_html__( '404 Error Page', 'backpacktraveler' ),
				'icon'  => 'fa fa-exclamation-triangle'
			)
		);
		
		$panel_404_header = backpacktraveler_mikado_add_admin_panel(
			array(
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a border bottom color for header area', 'backpacktraveler' )
			)
		);
		...
		$panel_404_options = backpacktraveler_mikado_add_admin_panel(
			array(
				'page'  => '__404_error_page',
				'name'  => 'panel_404_options',
				'title' => esc_html__( '404 Page Options', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a background image for 404 page', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'description' => esc_html__( 'Choose a pattern image for 404 page', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Title Image', 'backpacktraveler' ),
				'description' => esc_html__( 'Choose a background image for displaying above 404 page Title', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'name'          => '404_title',
				'default_value' => '',
				'label'         => esc_html__( 'Title', 'backpacktraveler' ),
				'description'   => esc_html__( 'Enter title for 404 page. Default label is "404".', 'backpacktraveler' )
			)
		);
		...
		$first_level_group = backpacktraveler_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Title Style', 'backpacktraveler' ),
				'description' => esc_html__( 'Define styles for 404 page title', 'backpacktraveler' )
			)
		);
        ...
        $first_level_group_responsive = backpacktraveler_mikado_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'first_level_group_responsive',
                'title'       => esc_html__( 'Title Style Responsive', 'backpacktraveler' ),
                'description' => esc_html__( 'Define responsive styles for 404 page title (under 680px)', 'backpacktraveler' )
            )
        );
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'name'          => '404_subtitle',
				'default_value' => '',
				'label'         => esc_html__( 'Subtitle', 'backpacktraveler' ),
				'description'   => esc_html__( 'Enter subtitle for 404 page. Default label is "PAGE NOT FOUND".', 'backpacktraveler' )
			)
		);
		...
		$second_level_group = backpacktraveler_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Subtitle Style', 'backpacktraveler' ),
				'description' => esc_html__( 'Define styles for 404 page subtitle', 'backpacktraveler' )
			)
		);
        ...
        $second_level_group_responsive = backpacktraveler_mikado_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'second_level_group_responsive',
                'title'       => esc_html__( 'Subtitle Style Responsive', 'backpacktraveler' ),
                'description' => esc_html__( 'Define responsive styles for 404 page subtitle (under 680px)', 'backpacktraveler' )
            )
        );
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'name'          => '404_text',
				'default_value' => '',
				'label'         => esc_html__( 'Text', 'backpacktraveler' ),
				'description'   => esc_html__( 'Enter text for 404 page.', 'backpacktraveler' )
			)
		);
		...
		$third_level_group = backpacktraveler_mikado_add_admin_group(
			array(
				...
				'title'       => esc_html__( 'Text Style', 'backpacktraveler' ),
				'description' => esc_html__( 'Define styles for 404 page text', 'backpacktraveler' )
			)
		);
        ...
        $third_level_group_responsive = backpacktraveler_mikado_add_admin_group(
            array(
                'parent'      => $panel_404_options,
                'name'        => 'third_level_group_responsive',
                'title'       => esc_html__( 'Text Style Responsive', 'backpacktraveler' ),
                'description' => esc_html__( 'Define responsive styles for 404 page text (under 680px)', 'backpacktraveler' )
            )
        );
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'label'       => esc_html__( 'Back to Home Button Label', 'backpacktraveler' ),
				'description' => esc_html__( 'Enter label for "Back to home" button', 'backpacktraveler' )
			)
		);
		...
		backpacktraveler_mikado_add_admin_field(
			array(
				...
				'description'   => esc_html__( 'Choose a style to make Back to Home button in that predefined style', 'backpacktraveler' ),
				'options'       => array(
					''            => esc_html__( 'Default', 'backpacktraveler' ),
					'light-style' => esc_html__( 'Light', 'backpacktraveler' )
				)
			)
		);
	}
	
	add_action( 'backpacktraveler_mikado_action_options_map', 'backpacktraveler_mikado_error_404_options_map', backpacktraveler_mikado_set_options_map_position( '404' ) );
}